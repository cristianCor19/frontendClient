...
function Navbar() {
  ...
  return (
    <Disclosure as="nav" className="bg-gray-800 navbar-main">
      {({ open: disclosureOpen }) => (
        <>
          <div className="mx-auto  px-2 md:px-6 lg:px-8 navbar-margin">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 md:static md:inset-auto md:ml-6 md:pr-0 md:pt-2">
